...
export default async function LeadExistingTasksPage({ params }: PageProps) {
  ...
  return (
    <div className="p-6 md:p-8 space-y-6 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm">
            Complete searchable directory of all active, closed, and historical tasks in {deptName}.
          </p>
        </div>
      </div>
      ...
      <HODTaskManager
        ...
        initialTab="existing"
        pageTitle="Existing Department Tasks Directory"
        pageDescription="All institutional, structured, and unstructured departmental assignments."
      />
    </div>
  )
}
