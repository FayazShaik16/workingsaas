    ...
    },
    {
      ...
      cell: ({ row }) => (
        <Button
          ...
          asChild
        >
          <a href={`/${orgId}/finance/wallet/${row.original.id}`}>Manage</a>
        </Button>
      ),
    },
  ]
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="flex gap-2">
        <Button asChild>
          <a href={`/${orgId}/finance/release-salary`}>Release Salary</a>
        </Button>
        <Button variant="outline" asChild>
          <a href={`/${orgId}/finance/loan-management`}>Manage Loans</a>
        </Button>
        <Button variant="outline" asChild>
          <a href={`/${orgId}/finance/reports`}>Financial Reports</a>
        </Button>
      </div>
    </div>
  )
