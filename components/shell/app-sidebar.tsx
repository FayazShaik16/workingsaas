...
export function getNavItemsForRole(
  ...
  const navMap: Record<string, NavItem[]> = {
    SYSTEM_ADMIN: [
      ...
      { label: "Departments",      href: `${base}/departments`,   icon: <Building2 size={16} /> },
      { label: "People & Roles",   href: `${base}/people`,        icon: <Users size={16} /> },
      { label: "Invitations",      href: `${base}/invitations`,   icon: <Mail size={16} /> },
      { label: "Bulk Import",      href: `${base}/import`,        icon: <FileSpreadsheet size={16} /> },
      { label: "Work Cycles",      href: `${base}/cycles`,        icon: <Clock size={16} /> },
      { label: "Blockchain Health",href: `${base}/blockchain`,    icon: <Sparkles size={16} /> },
      { label: "Legacy Cleanup",   href: `${base}/cleanup`,       icon: <ShieldAlert size={16} /> },
      { label: "Data Reset",       href: `${base}/reset`,         icon: <Zap size={16} /> },
    ...
    FINANCE_ADMIN: [
      ...
      { label: "Salary Settlement",href: `${base}/salary`,        icon: <Wallet size={16} /> },
